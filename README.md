...
Build a retail analytics project using SQL and PowerBI to resolve business pain points and help business make decisions.
...
Product, brand, category, cost & price

sales

~62.9K

Order-line transactions & delivery dates

stores

67

Country, area & opening date
...
Business context → Data validation → SQL/Python analysis → Power BI modeling & visualization → Insight → Business action

The 15 analytical questions in the case are treated as ad-hoc prompts rather than a rigid checklist.
